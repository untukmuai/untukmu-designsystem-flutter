...
class FileUploadAreaMobileWidget extends StatefulWidget {
  final String title;
  ...
  const FileUploadAreaMobileWidget({
    super.key,
  ...
  @override
  FileUploadAreaMobileWidgetState createState() => FileUploadAreaMobileWidgetState();
}

class FileUploadAreaMobileWidgetState extends State<FileUploadAreaMobileWidget> {
  String? _fileName;
  double? _fileSize;
